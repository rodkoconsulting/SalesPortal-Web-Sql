...
SELECT     MAS_POL.dbo.AR_SALESPERSON.SALESPERSONNAME AS RepName, MAS_POL.dbo.AR_SALESPERSON.UDF_TERRITORY AS Territory, 
                      ...
                      MAS_POL.dbo.AP_VENDOR.UDF_MASTER_VENDOR AS MasterVendor, d.QuantityOrdered AS Quantity, 
                      MAS_POL.dbo.PO_PurchaseOrderHeader.PurchaseOrderNo AS PoNo, d.LineKey AS LineIndex, 
                      ...
                      MAS_POL.dbo.PO_ShipToAddress.ShipToName AS ShipTom
...
FROM         MAS_POL.dbo.PO_PurchaseOrderHeader INNER JOIN
                      ...
                      MAS_POL.dbo.CI_Item ON d.ItemCode = MAS_POL.dbo.CI_Item.ItemCode ON 
                      MAS_POL.dbo.PO_PurchaseOrderHeader.PurchaseOrderNo = d.PurchaseOrderNo INNER JOIN
