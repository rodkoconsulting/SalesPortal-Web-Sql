/****** Object:  View [dbo].[SO_TopRepSalesMonth]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE VIEW [dbo].[SO_TopRepSalesMonth]
AS
SELECT     MAS_POL.dbo.AR_SALESPERSON.SALESPERSONNAME, Month(MAS_POL.dbo.AR_INVOICEHISTORYHEADER.InvoiceDate) as Month, YEAR(MAS_POL.dbo.AR_INVOICEHISTORYHEADER.InvoiceDate) as Year,
...
GROUP BY MAS_POL.dbo.AR_SALESPERSON.SALESPERSONNAME, Month(MAS_POL.dbo.AR_INVOICEHISTORYHEADER.InvoiceDate), YEAR(MAS_POL.dbo.AR_INVOICEHISTORYHEADER.InvoiceDate)
