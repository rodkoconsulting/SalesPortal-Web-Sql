/****** Object:  View [dbo].[RG_InventoryHeld]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE VIEW [dbo].[RG_InventoryHeld]
AS
...
WHERE  MAS_POL.dbo.PO_ReturnDetail.ItemType = '1' and MAS_POL.dbo.PO_ReturnHeader.ShipToCode like 'TAS%' AND MAS_POL.dbo.PO_ReturnDetail.WarehouseCode='000'
