/****** Object:  View [dbo].[AR_BillHoldCustom_old]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE VIEW [dbo].[AR_BillHoldCustom_old]
AS
SELECT     MAS_POL.dbo.AR_InvoiceHistoryHeader.TransactionDate, MAS_POL.dbo.CI_Item.ItemCode, MAS_POL.dbo.AR_Customer.CustomerName, 
                      MAS_POL.dbo.AR_Customer.SalespersonNo, MAS_POL.dbo.AR_InvoiceHistoryDetail.CostOfGoodsSoldAcctKey, 
                      MAS_POL.dbo.AR_InvoiceHistoryDetail.QuantityShipped, MAS_POL.dbo.AR_InvoiceHistoryDetail.UnitPrice, MAS_POL.dbo.AR_InvoiceHistoryDetail.UnitCost, 
