/****** Object:  View [dbo].[WebSiteExportData_Diff_Aws]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE VIEW [dbo].[WebSiteExportData_Diff_Aws]
AS
...
(
  ...
  FROM dbo.WebSiteExportData_Previous_Aws
