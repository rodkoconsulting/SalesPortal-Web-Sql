/****** Object:  View [dbo].[PortalWebPriceFuture]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE VIEW [dbo].[PortalWebPriceFuture]
AS
WITH Price AS
(
SELECT  ROW_NUMBER() OVER (PARTITION BY MAS_POL.dbo.IM_PriceCode.ITEMCODE, CustomerPriceLevel ORDER BY ValidDate_234) AS 'RN',
	 ITEMCODE,
