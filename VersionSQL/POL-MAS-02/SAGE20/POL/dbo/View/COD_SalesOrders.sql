...
WHERE     MAS_POL.dbo.AR_CUSTOMER.ARDIVISIONNO = '00' AND MAS_POL.dbo.SO_SalesOrderHeader.UDF_IS_BH <>'Y' AND ((MAS_POL.dbo.SO_SALESORDERHEADER.ORDERSTATUS='O' OR MAS_POL.dbo.SO_SALESORDERHEADER.ORDERSTATUS='N')OR(MAS_POL.dbo.SO_SALESORDERHEADER.CANCELREASONCODE <> 'MO' and MAS_POL.dbo.SO_SALESORDERHEADER.CANCELREASONCODE <> 'BO' and MAS_POL.dbo.SO_SALESORDERHEADER.CANCELREASONCODE <> 'IN')) and(MAS_POL.dbo.AR_CUSTOMER.TERMSCODE='00' or (MAS_POL.dbo.AR_CUSTOMER.TERMSCODE='30' and MAS_POL.dbo.AR_CUSTOMER.TERMSCODE <> MAS_POL.dbo.SO_SALESORDERHEADER.TERMSCODE) or (MAS_POL.dbo.AR_CUSTOMER.TERMSCODE='30' and MAS_POL.dbo.SO_SALESORDERHEADER.TERMSCODE='30') or MAS_POL.dbo.AR_CUSTOMER.TERMSCODE='10' or MAS_POL.dbo.AR_CUSTOMER.TERMSCODE='05' OR MAS_POL.dbo.AR_CUSTOMER.TERMSCODE='95')
