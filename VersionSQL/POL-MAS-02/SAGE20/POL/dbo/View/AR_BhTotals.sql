/****** Object:  View [dbo].[AR_BhTotals]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE VIEW [dbo].[AR_BhTotals]
AS
...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'AR_BhTotals'
EXECUTE sys.sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = N'1', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'AR_BhTotals'
