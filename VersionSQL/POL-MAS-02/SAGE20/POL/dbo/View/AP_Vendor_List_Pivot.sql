/****** Object:  View [dbo].[AP_Vendor_List_Pivot]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE VIEW [dbo].[AP_Vendor_List_Pivot]
AS
SELECT      DISTINCT MAS_POL.dbo.AP_VENDOR.APDivisionNo, MAS_POL.dbo.AP_VENDOR.VENDORNO, MAS_POL.dbo.AP_VENDOR.VENDORNAME
