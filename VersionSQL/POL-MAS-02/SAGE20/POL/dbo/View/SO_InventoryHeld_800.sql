/****** Object:  View [dbo].[SO_InventoryHeld_800]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE VIEW [dbo].[SO_InventoryHeld_800]
AS
with orderunion as
(
...
WHERE  d.ITEMTYPE='1' and d.WAREHOUSECODE='800' and h.SalesOrderNo = ''
GROUP BY d.ITEMCODE
)
SELECT ItemCode
