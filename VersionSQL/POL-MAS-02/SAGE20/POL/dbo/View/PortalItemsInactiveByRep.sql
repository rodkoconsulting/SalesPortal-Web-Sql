/****** Object:  View [dbo].[PortalItemsInactiveByRep]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE VIEW [dbo].[PortalItemsInactiveByRep]
AS
WITH ITEMHISTORY AS
(
SELECT     
	MAS_POL.dbo.AR_InvoiceHistoryDetail.ItemCode,MAS_POL.dbo.AR_Customer.SalespersonNo
...
UNION
SELECT DISTINCT MAS_POL.dbo.SO_SalesOrderDetail.ItemCode, MAS_POL.dbo.SO_SalesOrderHeader.SalespersonNo
...
SELECT DISTINCT SALESPERSONNO, ITEMHISTORY.ItemCode FROM ITEMHISTORY INNER JOIN
...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'PortalItemsInactiveByRep'
EXECUTE sys.sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = N'1', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'PortalItemsInactiveByRep'
