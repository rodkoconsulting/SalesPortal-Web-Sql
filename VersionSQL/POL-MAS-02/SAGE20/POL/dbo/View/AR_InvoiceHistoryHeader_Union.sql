/****** Object:  View [dbo].[AR_InvoiceHistoryHeader_Union]    Committed by VersionSQL https://www.versionsql.com ******/
...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'AR_InvoiceHistoryHeader_Union'
EXECUTE sys.sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = N'1', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'AR_InvoiceHistoryHeader_Union'
