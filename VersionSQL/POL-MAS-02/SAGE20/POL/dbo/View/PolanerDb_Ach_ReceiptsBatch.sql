/****** Object:  View [dbo].[PolanerDb_Ach_ReceiptsBatch]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE VIEW [dbo].[PolanerDb_Ach_ReceiptsBatch]
AS
WITH CashReceipts AS
(
...
ActiveBatch AS
(
SELECT     BatchNo, BatchSubType, BatchNo + ': ' + Comment as Comment
FROM         MAS_POL.dbo.GL_CompanyActiveBatch
)
SELECT DISTINCT TOP (100) PERCENT CashReceipts.BatchNo, ActiveBatch.Comment AS COMMENT
FROM         CashReceipts LEFT OUTER JOIN
                      ActiveBatch ON CashReceipts.BatchNo = ActiveBatch.BatchNo
ORDER BY CashReceipts.BatchNo
...
Begin DesignProperties = 
   ...
   Begin DiagramPane = 
      ...
      Begin Tables = 
         Begin Table = "AR_CashReceipts"
            ...
            TopColumn = 0
         End
         Begin Table = "GL_COMPANYACTIVEBATCH"
            Begin Extent = 
               Top = 6
               Left = 231
               Bottom = 99
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'PolanerDb_Ach_ReceiptsBatch'
EXECUTE sys.sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = N'1', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'PolanerDb_Ach_ReceiptsBatch'
