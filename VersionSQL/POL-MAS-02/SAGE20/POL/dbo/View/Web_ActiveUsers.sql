...
SELECT     DISTINCT dbo.Web_UserMappings.UserName, dbo.Web_UserMappings.AccountType, dbo.Web_UserMappings.RepCode,IsNull(MAS_POL.dbo.AR_Salesperson.UDF_STATE,'NY') 
                      AS State, MAS_POL.dbo.AR_Salesperson.SalespersonDivisionNo
...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'Web_ActiveUsers'
EXECUTE sys.sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = N'1', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'Web_ActiveUsers'
