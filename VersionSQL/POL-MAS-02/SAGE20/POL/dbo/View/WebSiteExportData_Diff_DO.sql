/****** Object:  View [dbo].[WebSiteExportData_Diff_DO]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE VIEW [dbo].[WebSiteExportData_Diff_DO]
AS
...
(
  ...
  FROM dbo.WebSiteExportData_Previous_DO
