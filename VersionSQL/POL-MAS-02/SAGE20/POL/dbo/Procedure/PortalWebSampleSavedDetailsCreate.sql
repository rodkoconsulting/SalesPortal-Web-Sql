/****** Object:  Procedure [dbo].[PortalWebSampleSavedDetailsCreate]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE dbo.PortalWebSampleSavedDetailsCreate
...
BEGIN
	BEGIN TRY
    BEGIN TRAN
	INSERT INTO dbo.PortalWebSampleSavedDetails(ORDERNO,ITEMCODE,Bottles,Comment)
