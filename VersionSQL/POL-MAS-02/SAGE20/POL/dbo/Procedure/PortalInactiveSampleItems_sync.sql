/****** Object:  Procedure [dbo].[PortalInactiveSampleItems_sync]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[PortalInactiveSampleItems_sync]
	@UserName varchar(25),
	@TimeSync datetime
AS
BEGIN
...
SELECT @TimeSyncPrev = MAX(TimeSync) FROM PortalInactiveSampleItems_Previous where RepCode=@RepCode
