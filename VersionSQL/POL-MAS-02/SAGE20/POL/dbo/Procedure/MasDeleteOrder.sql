/****** Object:  Procedure [dbo].[MasDeleteOrder]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[MasDeleteOrder]
...
declare @result int
set @arg=@OrderNo
set @cmd = 'E:\BoiCode\2020\OrderDelete2020.exe '
set @cmdline=@cmd+@arg
