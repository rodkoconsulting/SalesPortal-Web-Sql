/****** Object:  Procedure [dbo].[Web_Account_MoboDetailsDelete]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[Web_Account_MoboDetailsDelete]
...
BEGIN
    ...
    BEGIN TRY
    BEGIN TRAN
	DELETE FROM dbo.Web_Account_MoboDetails WHERE ORDERNO=@OrderNo and ITEMCODE=@ItemCode
	COMMIT TRAN
	END TRY
	BEGIN CATCH
