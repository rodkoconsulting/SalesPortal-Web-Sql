/****** Object:  Procedure [dbo].[PortalResendExceptionError]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[PortalResendExceptionError]
...
@body=@emailbody
EXEC [POL].[dbo].[PortalOrderExport] @OrderNumberInt
END
