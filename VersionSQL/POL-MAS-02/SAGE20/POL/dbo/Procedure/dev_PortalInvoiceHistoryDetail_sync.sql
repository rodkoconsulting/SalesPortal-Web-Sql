/****** Object:  Procedure [dbo].[dev_PortalInvoiceHistoryDetail_sync]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[dev_PortalInvoiceHistoryDetail_sync]
	@UserName varchar(25),
	@TimeSync datetime
AS
BEGIN
...
INTO #temp_dev_PortalInvoiceHistoryDetail_Current
...
SELECT @TimeSyncPrev = MAX(TimeSync) FROM dev_PortalInvoiceHistoryDetail_Previous where RepCode=@RepCode
...
if @@ROWCOUNT>0
BEGIN
DELETE FROM dev_PortalInvoiceHistoryDetail_Previous where RepCode = @RepCode
INSERT dev_PortalInvoiceHistoryDetail_Previous(TimeSync, RepCode,[InvoiceNo],[HSeqNo],[DSeqNo],[ItemCode],[Quantity],[UnitPrice],[Total])
SELECT
	TimeSync,
	RepCode,
	[InvoiceNo],[HSeqNo],[DSeqNo],[ItemCode],[Quantity],[UnitPrice],[Total]
