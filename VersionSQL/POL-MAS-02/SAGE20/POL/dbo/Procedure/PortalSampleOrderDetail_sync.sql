/****** Object:  Procedure [dbo].[PortalSampleOrderDetail_sync]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[PortalSampleOrderDetail_sync]
	@UserName varchar(25),
	@TimeSync datetime
AS
BEGIN
...
SELECT @TimeSyncPrev = MAX(TimeSync) FROM PortalSampleOrderDetail_Previous where RepCode=@RepCode
