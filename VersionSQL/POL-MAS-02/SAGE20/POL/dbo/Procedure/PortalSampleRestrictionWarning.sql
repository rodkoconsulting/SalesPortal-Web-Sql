/****** Object:  Procedure [dbo].[PortalSampleRestrictionWarning]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[PortalSampleRestrictionWarning]
...
@subject='Sales Portal Sample restriction error',
@body=@emailbody
END
