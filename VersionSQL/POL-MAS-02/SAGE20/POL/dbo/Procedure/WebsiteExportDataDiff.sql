/****** Object:  Procedure [dbo].[WebsiteExportDataDiff]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- =============================================
CREATE PROCEDURE WebsiteExportDataDiff 
...
BEGIN
	...
	SELECT
			...
			FROM [dbo].[WebSiteExportData_Diff_Aws] ORDER BY LastUpdated ASC, [Item Code] ASC, Operation ASC
END
