/****** Object:  Procedure [dbo].[PortalAccountList_sync_delete]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[PortalAccountList_sync_delete]
	@UserName varchar(25),
	@TimeSync datetime
AS
BEGIN
...
INSERT PortalAccountList_Current(TimeSync, RepCode, ARDivisionNo, CustomerNo, CustomerName, PriceLevel, ShipDays, CoopList, Buyer1, Buyer2, Buyer3, Buyer1Phone, Buyer2Phone, Buyer3Phone, Buyer1Email, Buyer2Email, Buyer3Email, Affil, Addr1, Addr2, City, State, Zip, Status, Rep, Region)
...
FROM         dbo.AR_Customer INNER JOIN
             dbo.PortalShipping ON dbo.AR_Customer.CustomerNo = dbo.PortalShipping.CUSTOMERNO INNER JOIN
...
WHERE (dbo.AR_CUSTOMER.PriceLevel <> '') and ((dbo.AR_CUSTOMER.ARDIVISIONNO = '00') or (dbo.AR_CUSTOMER.ARDIVISIONNO = '02')) and ((@AccountType = 'REP' and dbo.AR_Customer.SalespersonNo = @RepCode) or (@AccountType = 'OFF' and dbo.AR_Customer.SalespersonNo not like 'XX%'))
...
FROM
(
  SELECT 'D' as Operation, [ARDivisionNo],[CustomerNo],[CustomerName],[PriceLevel],[ShipDays],[CoopList],[Buyer1],[Buyer2],[Buyer3],[Buyer1Phone],[Buyer2Phone],[Buyer3Phone],[Buyer1Email],[Buyer2Email],[Buyer3Email],[Affil],[Addr1],[Addr2],[City],[State],[Zip],[Status],[Rep],[Region]
  FROM dbo.PortalAccountList_Previous
  WHERE [RepCode] = @RepCode
  UNION ALL
  SELECT 'I' as Operation, [ARDivisionNo],[CustomerNo],[CustomerName],[PriceLevel],[ShipDays],[CoopList],[Buyer1],[Buyer2],[Buyer3],[Buyer1Phone],[Buyer2Phone],[Buyer3Phone],[Buyer1Email],[Buyer2Email],[Buyer3Email],[Affil],[Addr1],[Addr2],[City],[State],[Zip],[Status],[Rep],[Region]
  FROM dbo.PortalAccountList_Current
  WHERE [RepCode] = @RepCode
) tmp
 
GROUP BY [ARDivisionNo],[CustomerNo],[CustomerName],[PriceLevel],[ShipDays],[CoopList],[Buyer1],[Buyer2],[Buyer3],[Buyer1Phone],[Buyer2Phone],[Buyer3Phone],[Buyer1Email],[Buyer2Email],[Buyer3Email],[Affil],[Addr1],[Addr2],[City],[State],[Zip],[Status],[Rep],[Region]
...
BEGIN
 SELECT
	...
	'C' as Operation,
	[ARDivisionNo],[CustomerNo],[CustomerName],[PriceLevel],[ShipDays],[CoopList],[Buyer1],[Buyer2],[Buyer3],[Buyer1Phone],[Buyer2Phone],[Buyer3Phone],[Buyer1Email],[Buyer2Email],[Buyer3Email],[Affil],[Addr1],[Addr2],[City],[State],[Zip],[Status],[Rep],[Region]
  FROM PortalAccountList_Current
END
if @@ROWCOUNT>0
BEGIN
DELETE FROM PortalAccountList_Previous where RepCode = @RepCode
INSERT PortalAccountList_Previous(TimeSync, RepCode, [ARDivisionNo],[CustomerNo],[CustomerName],[PriceLevel],[ShipDays],[CoopList],[Buyer1],[Buyer2],[Buyer3],[Buyer1Phone],[Buyer2Phone],[Buyer3Phone],[Buyer1Email],[Buyer2Email],[Buyer3Email],[Affil],[Addr1],[Addr2],[City],[State],[Zip],[Status],[Rep],[Region])
SELECT
	TimeSync,
	RepCode,
	[ARDivisionNo],[CustomerNo],[CustomerName],[PriceLevel],[ShipDays],[CoopList],[Buyer1],[Buyer2],[Buyer3],[Buyer1Phone],[Buyer2Phone],[Buyer3Phone],[Buyer1Email],[Buyer2Email],[Buyer3Email],[Affil],[Addr1],[Addr2],[City],[State],[Zip],[Status],[Rep],[Region]
...
WHERE RepCode = @RepCode
END
DELETE FROM PortalAccountList_Current where RepCode = @RepCode
END
