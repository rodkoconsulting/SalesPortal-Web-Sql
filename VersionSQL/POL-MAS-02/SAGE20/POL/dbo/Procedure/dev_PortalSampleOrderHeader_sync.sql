/****** Object:  Procedure [dbo].[dev_PortalSampleOrderHeader_sync]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[dev_PortalSampleOrderHeader_sync]
	@UserName varchar(25),
	@TimeSync datetime
AS
BEGIN
