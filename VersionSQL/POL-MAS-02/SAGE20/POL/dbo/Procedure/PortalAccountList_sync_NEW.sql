/****** Object:  Procedure [dbo].[PortalAccountList_sync_NEW]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[PortalAccountList_sync_NEW]
	@UserName varchar(25),
	@TimeSync datetime
AS
BEGIN
...
INSERT PortalAccountList_Current(TimeSync, RepCode, ARDivisionNo, CustomerNo, CustomerName, PriceLevel, ShipDays, CoopList, Buyer1, Buyer2, Buyer3, Buyer1Phone, Buyer2Phone, Buyer3Phone, Buyer1Email, Buyer2Email, Buyer3Email, Affil, Addr1, Addr2, City, State, Zip, Status, Rep, Region, PrimaryShipTo)
SELECT     @CurrentDate as TimeSync,
		   ...
		   left(dbo.PortalShipping_NEW.ShipDays,5) as ShipDays,
...
FROM         dbo.AR_Customer INNER JOIN
             dbo.PortalShipping_NEW ON dbo.AR_Customer.CustomerNo = dbo.PortalShipping_NEW.CUSTOMERNO AND dbo.AR_Customer.ARDivisionNo = dbo.PortalShipping_NEW.ARDivisionNo INNER JOIN
...
FROM
(
  SELECT 'D' as Operation, [ARDivisionNo],[CustomerNo],[CustomerName],[PriceLevel],[ShipDays],[CoopList],[Buyer1],[Buyer2],[Buyer3],[Buyer1Phone],[Buyer2Phone],[Buyer3Phone],[Buyer1Email],[Buyer2Email],[Buyer3Email],[Affil],[Addr1],[Addr2],[City],[State],[Zip],[Status],[Rep],[Region],PrimaryShipTo
  FROM dbo.PortalAccountList_Previous
  WHERE [RepCode] = @RepCode
  UNION ALL
  SELECT 'I' as Operation, [ARDivisionNo],[CustomerNo],[CustomerName],[PriceLevel],[ShipDays],[CoopList],[Buyer1],[Buyer2],[Buyer3],[Buyer1Phone],[Buyer2Phone],[Buyer3Phone],[Buyer1Email],[Buyer2Email],[Buyer3Email],[Affil],[Addr1],[Addr2],[City],[State],[Zip],[Status],[Rep],[Region],PrimaryShipTo
  FROM dbo.PortalAccountList_Current
  WHERE [RepCode] = @RepCode
) tmp
 
GROUP BY [ARDivisionNo],[CustomerNo],[CustomerName],[PriceLevel],[ShipDays],[CoopList],[Buyer1],[Buyer2],[Buyer3],[Buyer1Phone],[Buyer2Phone],[Buyer3Phone],[Buyer1Email],[Buyer2Email],[Buyer3Email],[Affil],[Addr1],[Addr2],[City],[State],[Zip],[Status],[Rep],[Region],PrimaryShipTo
...
BEGIN
 SELECT
	...
	'C' as Operation,
	[ARDivisionNo],[CustomerNo],[CustomerName],[PriceLevel],[ShipDays],[CoopList],[Buyer1],[Buyer2],[Buyer3],[Buyer1Phone],[Buyer2Phone],[Buyer3Phone],[Buyer1Email],[Buyer2Email],[Buyer3Email],[Affil],[Addr1],[Addr2],[City],[State],[Zip],[Status],[Rep],[Region],PrimaryShipTo
  FROM PortalAccountList_Current
END
if @@ROWCOUNT>0
BEGIN
DELETE FROM PortalAccountList_Previous where RepCode = @RepCode
INSERT PortalAccountList_Previous(TimeSync, RepCode, [ARDivisionNo],[CustomerNo],[CustomerName],[PriceLevel],[ShipDays],[CoopList],[Buyer1],[Buyer2],[Buyer3],[Buyer1Phone],[Buyer2Phone],[Buyer3Phone],[Buyer1Email],[Buyer2Email],[Buyer3Email],[Affil],[Addr1],[Addr2],[City],[State],[Zip],[Status],[Rep],[Region],PrimaryShipTo)
SELECT
	TimeSync,
	RepCode,
	[ARDivisionNo],[CustomerNo],[CustomerName],[PriceLevel],[ShipDays],[CoopList],[Buyer1],[Buyer2],[Buyer3],[Buyer1Phone],[Buyer2Phone],[Buyer3Phone],[Buyer1Email],[Buyer2Email],[Buyer3Email],[Affil],[Addr1],[Addr2],[City],[State],[Zip],[Status],[Rep],[Region],PrimaryShipTo
