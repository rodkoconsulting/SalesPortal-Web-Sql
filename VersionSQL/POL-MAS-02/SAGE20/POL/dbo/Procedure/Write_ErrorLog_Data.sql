/****** Object:  Procedure [dbo].[Write_ErrorLog_Data]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[Write_ErrorLog_Data]
...
SELECT @errordescription=ErrorDescription FROM ERRORLOG_INFO WHERE ErrorCode=@ErrorNumber;
