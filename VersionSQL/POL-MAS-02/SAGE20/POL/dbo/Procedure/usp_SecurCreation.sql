/****** Object:  Procedure [dbo].[usp_SecurCreation]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[usp_SecurCreation] @user_name sysname = NULL, @dbname sysname = NULL
--WITH ENCRYPTION
AS
