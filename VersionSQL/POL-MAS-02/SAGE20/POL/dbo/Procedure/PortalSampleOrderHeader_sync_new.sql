/****** Object:  Procedure [dbo].[PortalSampleOrderHeader_sync_new]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[PortalSampleOrderHeader_sync_new]
	@UserName varchar(25),
	@TimeSync datetime
AS
BEGIN
