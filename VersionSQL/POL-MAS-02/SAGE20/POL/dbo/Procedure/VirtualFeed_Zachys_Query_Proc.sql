/****** Object:  Procedure [dbo].[VirtualFeed_Zachys_Query_Proc]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE procedure dbo.VirtualFeed_Zachys_Query_Proc
AS
BEGIN
	SET NOCOUNT ON   
SELECT     Products = (SELECT i.ITEMCODE AS [Item #]
