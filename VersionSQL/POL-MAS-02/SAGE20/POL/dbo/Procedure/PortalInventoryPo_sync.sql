/****** Object:  Procedure [dbo].[PortalInventoryPo_sync]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[PortalInventoryPo_sync]
	@UserName varchar(25),
	@TimeSync datetime
AS
BEGIN
...
INTO #temp_PortalInventoryPo_Current
FROM
...
(
  ...
  FROM #temp_PortalInventoryPo_Current
  WHERE [RepCode] = @RepCode
) tmp
...
INSERT PortalInventoryPo_Previous(TimeSync, RepCode, ItemCode, PurchaseOrderNo,OnPo, Eta, PoDate, PoCmt)
SELECT
	TimeSync,
	RepCode,
	ItemCode,
