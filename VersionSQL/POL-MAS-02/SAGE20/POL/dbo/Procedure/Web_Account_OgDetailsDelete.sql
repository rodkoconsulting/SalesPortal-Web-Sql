/****** Object:  Procedure [dbo].[Web_Account_OgDetailsDelete]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[Web_Account_OgDetailsDelete]
...
BEGIN TRANSACTION
    ...
    DELETE FROM dbo.Web_Account_OgDetails WHERE ORDERNO=@OrderNo and ITEMCODE=@ItemCode
COMMIT TRANSACTION
END TRY
BEGIN CATCH
