/****** Object:  Table [dbo].[dev_PortalInactiveItems_Previous]    Committed by VersionSQL https://www.versionsql.com ******/

SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
CREATE TABLE [dbo].[dev_PortalInactiveItems_Previous](
 ...
 CONSTRAINT [PK__dev_PortalIn__8DDEE42D110B679F] PRIMARY KEY CLUSTERED 
(
	[RepCode] ASC,
	[ItemCode] ASC
...
ALTER TABLE [dbo].[dev_PortalInactiveItems_Previous] ADD  CONSTRAINT [DF__dev_PortalIna__Restr__12F3B011]  DEFAULT ('') FOR [RestrictMo]
ALTER TABLE [dbo].[dev_PortalInactiveItems_Previous] ADD  CONSTRAINT [DF_dev_PortalInactiveItems_Previous_Regen]  DEFAULT ('N') FOR [Regen]
ALTER TABLE [dbo].[dev_PortalInactiveItems_Previous] ADD  CONSTRAINT [DF_dev_PortalInactiveItems_Previous_Natural]  DEFAULT ('N') FOR [Natural]
ALTER TABLE [dbo].[dev_PortalInactiveItems_Previous] ADD  CONSTRAINT [DF_dev_PortalInactiveItems_Previous_Vegan]  DEFAULT ('N') FOR [Vegan]
ALTER TABLE [dbo].[dev_PortalInactiveItems_Previous] ADD  CONSTRAINT [DF_dev_PortalInactiveItems_Previous_HVE]  DEFAULT ('N') FOR [HVE]
