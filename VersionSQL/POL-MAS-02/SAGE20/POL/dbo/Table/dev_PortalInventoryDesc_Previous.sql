/****** Object:  Table [dbo].[dev_PortalInventoryDesc_Previous]    Committed by VersionSQL https://www.versionsql.com ******/

SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
CREATE TABLE [dbo].[dev_PortalInventoryDesc_Previous](
 ...
 CONSTRAINT [PK__dev_PortalIn__8DDEE42D32B6742D] PRIMARY KEY CLUSTERED 
(
	[RepCode] ASC,
	[ItemCode] ASC
...
ALTER TABLE [dbo].[dev_PortalInventoryDesc_Previous] ADD  CONSTRAINT [DF__dev_PortalInv__Restr__1B33F057]  DEFAULT ('') FOR [RestrictMo]
ALTER TABLE [dbo].[dev_PortalInventoryDesc_Previous] ADD  CONSTRAINT [DF_dev_PortalInventoryDesc_Previous_Regen]  DEFAULT ('N') FOR [Regen]
ALTER TABLE [dbo].[dev_PortalInventoryDesc_Previous] ADD  CONSTRAINT [DF_dev_PortalInventoryDesc_Previous_Natural]  DEFAULT ('N') FOR [Natural]
ALTER TABLE [dbo].[dev_PortalInventoryDesc_Previous] ADD  CONSTRAINT [DF_dev_PortalInventoryDesc_Previous_Vegan]  DEFAULT ('N') FOR [Vegan]
ALTER TABLE [dbo].[dev_PortalInventoryDesc_Previous] ADD  CONSTRAINT [DF_dev_PortalInventoryDesc_Previous_HVE]  DEFAULT ('N') FOR [HVE]
