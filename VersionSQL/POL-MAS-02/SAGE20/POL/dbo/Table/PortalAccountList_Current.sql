/****** Object:  Table [dbo].[PortalAccountList_Current]    Committed by VersionSQL https://www.versionsql.com ******/

SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
CREATE TABLE [dbo].[PortalAccountList_Current](
 ...
 CONSTRAINT [PK__PortalAc__D38DF47355D59338] PRIMARY KEY CLUSTERED 
(
	[RepCode] ASC,
	[ARDivisionNo] ASC,
	[CustomerNo] ASC
...
ALTER TABLE [dbo].[PortalAccountList_Current] ADD  CONSTRAINT [DF_PortalAccountList_Current_PrimaryShipTo]  DEFAULT ((0)) FOR [PrimaryShipTo]
ALTER TABLE [dbo].[PortalAccountList_Current] ADD  CONSTRAINT [DF_PortalAccountList_Current_ShipVia]  DEFAULT ('FDL') FOR [ShipVia]
