/****** Object:  Table [dbo].[PortalInactiveItems_Current]    Committed by VersionSQL https://www.versionsql.com ******/

SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
CREATE TABLE [dbo].[PortalInactiveItems_Current](
 ...
 CONSTRAINT [PK__PortalIn__8DDEE42D0C46B282] PRIMARY KEY CLUSTERED 
(
	[RepCode] ASC,
	[ItemCode] ASC
...
ALTER TABLE [dbo].[PortalInactiveItems_Current] ADD  CONSTRAINT [DF__PortalIna__Restr__0E2EFAF4]  DEFAULT ('') FOR [RestrictMo]
ALTER TABLE [dbo].[PortalInactiveItems_Current] ADD  CONSTRAINT [DF_PortalInactiveItems_Current_Regen]  DEFAULT ('N') FOR [Regen]
ALTER TABLE [dbo].[PortalInactiveItems_Current] ADD  CONSTRAINT [DF_PortalInactiveItems_Current_Natural]  DEFAULT ('N') FOR [Natural]
ALTER TABLE [dbo].[PortalInactiveItems_Current] ADD  CONSTRAINT [DF_PortalInactiveItems_Current_Vegan]  DEFAULT ('N') FOR [Vegan]
ALTER TABLE [dbo].[PortalInactiveItems_Current] ADD  CONSTRAINT [DF_PortalInactiveItems_Current_HVE]  DEFAULT ('N') FOR [HVE]
