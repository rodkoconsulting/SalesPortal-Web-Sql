/****** Object:  Table [dbo].[dev_PortalAccountList_Previous]    Committed by VersionSQL https://www.versionsql.com ******/

SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
CREATE TABLE [dbo].[dev_PortalAccountList_Previous](
 ...
 CONSTRAINT [PK__dev_PortalAc__D38DF47352050254] PRIMARY KEY CLUSTERED 
(
	[RepCode] ASC,
	[ARDivisionNo] ASC,
	[CustomerNo] ASC
...
ALTER TABLE [dbo].[dev_PortalAccountList_Previous] ADD  CONSTRAINT [DF_dev_PortalAccountList_Previous_PrimaryShipTo]  DEFAULT ((0)) FOR [PrimaryShipTo]
ALTER TABLE [dbo].[dev_PortalAccountList_Previous] ADD  CONSTRAINT [DF_dev_PortalAccountList_Previous_ShipVia]  DEFAULT ('FDL') FOR [ShipVia]
