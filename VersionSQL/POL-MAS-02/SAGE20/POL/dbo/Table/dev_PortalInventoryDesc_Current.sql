/****** Object:  Table [dbo].[dev_PortalInventoryDesc_Current]    Committed by VersionSQL https://www.versionsql.com ******/

SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
CREATE TABLE [dbo].[dev_PortalInventoryDesc_Current](
 ...
 CONSTRAINT [PK__dev_PortalIn__8DDEE42D36870511] PRIMARY KEY CLUSTERED 
(
	[RepCode] ASC,
	[ItemCode] ASC
...
ALTER TABLE [dbo].[dev_PortalInventoryDesc_Current] ADD  CONSTRAINT [DF__dev_PortalInv__Restr__1A3FCC1E]  DEFAULT ('') FOR [RestrictMo]
ALTER TABLE [dbo].[dev_PortalInventoryDesc_Current] ADD  CONSTRAINT [DF_dev_PortalInventoryDesc_Current_Regen]  DEFAULT ('N') FOR [Regen]
ALTER TABLE [dbo].[dev_PortalInventoryDesc_Current] ADD  CONSTRAINT [DF_dev_PortalInventoryDesc_Current_Natural]  DEFAULT ('N') FOR [Natural]
ALTER TABLE [dbo].[dev_PortalInventoryDesc_Current] ADD  CONSTRAINT [DF_dev_PortalInventoryDesc_Current_Vegan]  DEFAULT ('N') FOR [Vegan]
ALTER TABLE [dbo].[dev_PortalInventoryDesc_Current] ADD  CONSTRAINT [DF_dev_PortalInventoryDesc_Current_HVE]  DEFAULT ('N') FOR [HVE]
