/****** Object:  Procedure [dbo].[PortalWebSalesAnalysisProc-new]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[PortalWebSalesAnalysisProc-new]
	@UserName varchar(25)
AS
BEGIN
	SET NOCOUNT ON
